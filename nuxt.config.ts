  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:title', content: 'Rush Hour Planner - Traffic Forecast & Route Optimizer' },
        { property: 'og:description', content: 'Plan your commute and avoid rush hour traffic with real-time traffic forecasts. Find the optimal time to drive, analyze traffic patterns, and save time with our 24-hour traffic analysis tool. Perfect for answering when is the best time to drive? and what time should I leave?' },
        { property: 'og:image', content: 'https://rushhourplanner.com/og-image.jpg' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { property: 'og:image:alt', content: 'Rush Hour Planner - Traffic forecast dashboard showing optimal driving times' },
        { property: 'og:site_name', content: 'Rush Hour Planner' },
        { property: 'og:locale', content: 'en_US' },
        { property: 'twitter:card', content: 'summary_large_image' },
        { property: 'twitter:url', content: 'https://rushhourplanner.com/' },
        { property: 'twitter:title', content: 'Rush Hour Planner - Traffic Forecast & Route Optimizer' },
        { property: 'twitter:description', content: 'Plan your commute and avoid rush hour traffic with real-time traffic forecasts. Find the optimal time to drive, analyze traffic patterns, and save time with our 24-hour traffic analysis tool. Perfect for answering when is the best time to drive? and what time should I leave?' },
        { property: 'twitter:image', content: 'https://rushhourplanner.com/og-image.jpg' },
        { property: 'twitter:image:alt', content: 'Rush Hour Planner - Traffic forecast dashboard showing optimal driving times' },
      ...
      script: [
        {
          ...
          json: {
            ...
            "@type": "WebApplication",
            "name": "Rush Hour Planner",
            "description": "Plan your commute and avoid rush hour traffic with real-time traffic forecasts. Find the optimal time to drive, analyze traffic patterns, and save time with our 24-hour traffic analysis tool powered by Google Maps.",
              ...
              "mainEntity": [
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "The best time to drive varies by route and day, but generally early morning (before 6 AM), mid-morning (9:30-11 AM), early afternoon (1-3 PM), and late evening (after 7 PM) have lighter traffic. Use our traffic forecast tool to find the optimal time for your specific route."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "To avoid morning rush hour, leave before 6:30 AM or after 9:30 AM. For evening rush hour, travel before 4 PM or after 7 PM. Our planner analyzes your specific route to give personalized departure time recommendations."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Rush hour traffic is typically worst between 7-9 AM and 5-7 PM on weekdays. However, traffic patterns vary by location and route. Our tool provides 24-hour traffic forecasts to help you identify peak congestion times for your specific journey."
                  }
                }
              ]
            }
